...
Test the code implemented by Developer. Run linting, type checking, tests, and builds. If everything passes, output "PASS". If there are issues, output a detailed bug report for Developer to fix.
  ...
  "bugs": [
    {
      ...
      "type": "type_error|runtime_error|logic_error|test_failure",
      "file": "src/main.py",
      "line": 42,
